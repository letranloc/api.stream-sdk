...
exports.MethodOptions = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.idempotencyLevel !==
            ...
            writer
                .uint32(272)
                .int32(methodOptions_IdempotencyLevelToNumber(message.idempotencyLevel));
        }
        for (const v of message.uninterpretedOption) {
            exports.UninterpretedOption.encode(v, writer.uint32(7994).fork()).ldelim();
        }
    ...
    fromPartial(object) {
        ...
        message.idempotencyLevel =
            (_b = object.idempotencyLevel) !== null && _b !== void 0 ? _b : MethodOptions_IdempotencyLevel.IDEMPOTENCY_UNKNOWN;
        message.uninterpretedOption =
            ((_c = object.uninterpretedOption) === null || _c === void 0 ? void 0 : _c.map((e) => exports.UninterpretedOption.fromPartial(e))) || [];
        return message;
    },
